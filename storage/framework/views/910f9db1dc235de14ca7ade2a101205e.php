...
<body class="bg-gray-100 font-sans" data-admin-id="<?php echo e(auth('admin')->id()); ?>">
  ...
  <div class="flex min-h-screen">
    ...
    <aside class="w-64 bg-white border-r shadow-sm">
      ...
      <nav class="p-4 space-y-2">
        ...
        <a href="<?php echo e(route('pesananAdmin')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-full hover:bg-gray-100">
        ...
        <a href="<?php echo e(route('chat.admin')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-full bg-gray-100">
...
</html><?php /**PATH D:\Website\website-gorden\resources\views/Admin/ChatAdmin.blade.php ENDPATH**/ ?>