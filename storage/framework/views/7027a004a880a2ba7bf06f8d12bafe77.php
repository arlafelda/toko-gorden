...
<body class="min-h-screen bg-white font-sans">
    ...
    <aside class="fixed top-0 left-0 h-screen w-80 bg-white p-4 border-r border-gray-200 z-10">
        ...
        <nav class="flex flex-col gap-2">
            ...
            <a href="<?php echo e(route('admin.trafik')); ?>" class="flex items-center gap-3 px-3 py-2 rounded-full bg-[#f0f2f4]">
    ...
    <main class="ml-80 px-10 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            <div class="border rounded-xl p-6">
                ...
                <p class="text-3xl font-bold text-blue-900 truncate"><?php echo e($totalPengunjung); ?></p>
            </div>

            <div class="border rounded-xl p-6">
                <p class="text-base font-medium text-green-900">Hari Ini</p>
                <p class="text-3xl font-bold text-green-900 truncate"><?php echo e($pengunjungHariIni); ?></p>
            </div>

            <div class="border rounded-xl p-6">
                <p class="text-base font-medium text-orange-900">Minggu Ini</p>
                <p class="text-3xl font-bold text-orange-900 truncate"><?php echo e($pengunjungMingguIni); ?></p>
            </div>

            <div class="border rounded-xl p-6">
                <p class="text-base font-medium text-purple-900">Bulan Ini</p>
                <p class="text-3xl font-bold text-purple-900 truncate"><?php echo e($pengunjungBulanIni); ?></p>
            </div>
        </div>
    ...
    <script>
        ...
        fetch('<?php echo e(route("admin.trafik.data")); ?>')
...
<?php /**PATH D:\Website\website-gorden\resources\views/Admin/Trafik.blade.php ENDPATH**/ ?>