...
<head>
    ...
    <title><?php echo e($product->nama_produk); ?> - Detail Produk</title>
...
<body class="bg-gray-100 font-sans">
    <div class="container mx-auto p-4">
        ...
        <header class="flex items-center mb-6">
            <a href="<?php echo e(route('produk.user')); ?>" class="text-gray-600 hover:text-gray-800 flex items-center">
        ...
        <div class="flex flex-col md:flex-row bg-white rounded-lg shadow-md p-6">
            <div class="w-full md:w-1/2">
                <img alt="<?php echo e($product->nama_produk); ?>" class="w-full h-auto rounded-lg"
                    src="<?php echo e(asset('uploads/' . $product->gambar)); ?>" />
            </div>
            <div class="w-full md:w-1/2 md:pl-8 mt-6 md:mt-0">
                <h1 class="text-3xl font-bold text-gray-800"><?php echo e($product->nama_produk); ?></h1>
                <?php
                ...
                <div class="flex items-center mt-1">
                    <?php for($i = 1; $i <= 5; $i++): ?>    
                        ...
                        <?php endif; ?>
                        <?php endfor; ?>
                        <span class="text-sm text-gray-600 ml-2"><?php echo e($rating); ?>/5</span>
                </div>
                ...
                <p class="text-gray-600 mb-4"><?php echo nl2br(e($product->deskripsi)); ?></p>
        ...
        <div class="bg-white rounded-lg w-full max-w-md overflow-hidden shadow-lg">
            <div class="p-4 border-b flex justify-between items-start">
                <div class="flex items-center gap-4">
                    <img src="<?php echo e(asset('uploads/' . $product->gambar)); ?>" class="w-20 h-20 rounded" alt="Produk" />
                    <div>
                        ...
                        <p class="line-through text-sm text-gray-400">
                            <span id="hargaDiskonPopup">Rp<?php echo e(number_format($product->harga * 2, 0, ',', '.')); ?></span>
                        </p>
            ...
            <form method="POST" action="<?php echo e(route('keranjang.tambah', $product->id)); ?>">
                <?php echo csrf_field(); ?>
                ...
                <div class="p-4">
                    ...
                    <div class="grid grid-cols-4 gap-3">
                        ...
                        <button type="button"
                            ...
                            data-ukuran="<?php echo e($size->ukuran); ?>"
                            data-harga="<?php echo e($size->harga); ?>"
                            data-stok="<?php echo e($size->stok); ?>">
                            <?php echo e($ukuranFormatted); ?>
    ...
    <div class="bg-white mt-6 rounded-lg shadow-md p-6">
        ...
        <div class="border-b border-gray-200 pb-4 mb-4">
            <div class="flex items-center mb-1">
                <strong class="text-gray-800"><?php echo e($review->user->name); ?></strong>
            ...
            <p class="text-gray-600"><?php echo e($review->ulasan); ?></p>
        ...
        <form action="<?php echo e(route('ulasan.store')); ?>" method="POST" class="mt-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="flex items-center space-x-1 mb-4">
                <?php for($i = 1; $i <= 5; $i++): ?>
                    <button type="button" class="star text-2xl text-gray-400 hover:text-yellow-400 focus:outline-none" data-value="<?php echo e($i); ?>">★</button>
                    <?php endfor; ?>
            </div>
        ...
        <?php else: ?>
        <p class="text-sm text-gray-600 mt-6">Silakan <a href="<?php echo e(route('login')); ?>" class="text-blue-500 hover:underline">login</a> untuk memberikan ulasan.</p>
        <?php endif; ?>
    </div>
    </div>
    ...
    <script>
        ...
        function submitFormCheckout() {
            ...
            form.method = 'POST';
            form.action = '<?php echo e(route("produk.checkoutLangsung", $product->id)); ?>';
            form.innerHTML = `
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.Chat', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Website\website-gorden\resources\views/Produk/DetailProduk.blade.php ENDPATH**/ ?>