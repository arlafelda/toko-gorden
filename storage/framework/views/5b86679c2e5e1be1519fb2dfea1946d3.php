        ...
        <form action="<?php echo e(route('produk.store')); ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                <textarea id="deskripsi" name="deskripsi" rows="4"
                    ...
                    placeholder="Tulis deskripsi produk di sini..."><?php echo e(old('deskripsi')); ?></textarea>
            </div>
...
</html><?php /**PATH D:\Website\website-gorden\resources\views/Produk/TambahProduk.blade.php ENDPATH**/ ?>