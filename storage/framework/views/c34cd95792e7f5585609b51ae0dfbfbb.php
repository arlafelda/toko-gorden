    ...
    <div class="ml-80 min-h-screen p-8">
        <main class="flex-1 bg-gray-50">
            <div class="mx-auto max-w-7xl">
                ...
                <!-- Form Pencarian -->
                <form method="GET" action="<?php echo e(route('admin.pelanggan')); ?>" class="flex flex-1 gap-4 mb-6">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full min-w-max table-auto">
                            ...
                            <tbody class="divide-y divide-gray-200">
                                <?php $__empty_1 = true; $__currentLoopData = $pelanggan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="px-6 py-4 text-sm font-medium text-gray-900"><?php echo e($user->name); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($user->address ?? '-'); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($user->phone_number ?? '-'); ?></td>
                                    <td class="px-6 py-4 text-sm text-gray-600"><?php echo e($user->orders->count()); ?> pesanan</td>
...
</html><?php /**PATH D:\Website\website-gorden\resources\views/Admin/DaftarPelanggan.blade.php ENDPATH**/ ?>